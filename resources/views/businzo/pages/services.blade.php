...
<div class="pt-32 pb-20 relative overflow-hidden bg-background border-b border-white/5">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10" data-aos="fade-up">
        <h1 class="text-5xl md:text-7xl font-black font-['Outfit'] tracking-tight mb-6 max-w-4xl">Software development <span class="text-gray-600">services</span> for modern teams.</h1>
        <p class="text-xl text-gray-400 max-w-2xl font-light">Web applications, mobile apps, AI/ML engineering, and custom software — delivered with clean architecture, secure implementation, and production-ready deployment.</p>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-24 space-y-40">
            ...
            <div class="order-2 lg:order-1" data-aos="fade-right">
                ...
                <div class="space-y-6 mb-10">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Scalable APIs & Architecture</h4>
                            <p class="text-sm text-gray-500">Clean boundaries, modular services, and API-first design that supports rapid iteration.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Role-Based Access Control</h4>
                            <p class="text-sm text-gray-500">Secure authentication, permissions, and audit-friendly workflows.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Production-Ready Delivery</h4>
                            <p class="text-sm text-gray-500">Dockerized environments, automated tests, static analysis, and safe deployments.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl p-2 relative">
                    ...
                    <div class="bg-[#0a0a0a] border border-white/10 rounded-2xl h-[400px] flex flex-col overflow-hidden relative z-10">
                        <div class="h-10 border-b border-white/10 flex items-center px-4 gap-2 bg-[#111111]">
                            ...
                            <span class="text-xs text-gray-500 ml-2 font-mono">app.company.com — Dashboard</span>
                        </div>
                        <div class="flex-grow p-6">
                            <div class="space-y-3 mb-6">
                                <div class="text-xs text-gray-500 uppercase tracking-wider">Admin Portal</div>
                                <div class="grid grid-cols-3 gap-2">
                                    <div class="h-16 rounded-lg bg-blue-500/10 border border-blue-500/20 flex flex-col items-center justify-center">
                                        <i class='bx bx-bell text-blue-400'></i>
                                        <span class="text-[10px] text-gray-400 mt-1">Notices</span>
                                    </div>
                                    <div class="h-16 rounded-lg bg-white/5 border border-white/10 flex flex-col items-center justify-center">
                                        <i class='bx bx-pie-chart-alt-2 text-gray-400'></i>
                                        <span class="text-[10px] text-gray-400 mt-1">Billing</span>
                                    </div>
                                    <div class="h-16 rounded-lg bg-white/5 border border-white/10 flex flex-col items-center justify-center">
                                        <i class='bx bx-support text-gray-400'></i>
                                        <span class="text-[10px] text-gray-400 mt-1">Helpdesk</span>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="h-24 bg-gradient-to-r from-blue-500/10 to-transparent rounded mt-6 border border-blue-500/20 flex items-center px-4">
                                <div class="text-xs text-gray-400"><span class="text-blue-400 font-bold">42</span> open tickets · <span class="text-green-400 font-bold">99.9%</span> uptime</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-[#0a0a0a] border border-white/10 rounded-3xl h-[500px] flex flex-col overflow-hidden relative z-10 w-[250px] mx-auto my-4 shadow-2xl">
                        ...
                        <div class="flex-grow p-4 pt-10 flex flex-col gap-4 relative">
                            <div class="text-center mb-2">
                                <div class="text-xs text-gray-500">Mobile App</div>
                                <div class="text-sm font-bold text-white">Green Valley Society</div>
                            </div>
                            <div class="h-24 rounded-xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-white/5 flex items-center justify-center">
                                <div class="text-center">
                                    <div class="text-xs text-gray-400">Maintenance Due</div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="h-16 rounded-xl bg-white/5 flex flex-col items-center justify-center">
                                    <i class='bx bx-support text-purple-400 text-lg'></i>
                                    <span class="text-[10px] text-gray-400 mt-1">Helpdesk</span>
                                </div>
                                <div class="h-16 rounded-xl bg-white/5 flex flex-col items-center justify-center">
                                    <i class='bx bx-group text-blue-400 text-lg'></i>
                                    <span class="text-[10px] text-gray-400 mt-1">Community</span>
                                </div>
                            </div>
                            <div class="h-10 rounded-xl bg-purple-500/20 border border-purple-500/30 flex items-center justify-center text-xs font-bold text-purple-300 mt-auto">Pay Now</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6 mb-10">
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Polished native UI with push notifications, biometric login, and offline-capable bill viewing.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Material Design interfaces with Jetpack Compose, connected to the same JWT API endpoints.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                            <i class='bx bx-qr text-xl text-purple-400'></i>
                        </div>
                        <div>
                            <h4 class="text-white font-bold mb-1">Secure Mobile + Backend</h4>
                            <p class="text-sm text-gray-500">JWT/OAuth, robust APIs, telemetry, and scalable backend services.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="order-2 lg:order-1" data-aos="fade-right">
                ...
                <div class="space-y-6 mb-10">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">RAG over Private Records</h4>
                            <p class="text-sm text-gray-500">Semantic search across society documents, bylaws, and maintenance history — answers grounded in your data, not the public internet.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Smart Workflow Automation</h4>
                            <p class="text-sm text-gray-500">AI-assisted ticket classification, approval routing, and vendor matching based on service history and reviews.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                            <i class='bx bx-line-chart text-xl text-accent-400'></i>
                        </div>
                        <div>
                            <h4 class="text-white font-bold mb-1">Predictive Analytics</h4>
                            <p class="text-sm text-gray-500">Maintenance payment forecasting, vendor performance scoring, and community engagement insights.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="order-1 lg:order-2" data-aos="fade-left">
                <div class="glass-panel rounded-3xl p-2 relative">
                    ...
                    <div class="bg-[#0a0a0a] border border-white/10 rounded-2xl h-[400px] flex flex-col overflow-hidden relative z-10 p-6">
                        <div class="text-xs text-gray-500 uppercase tracking-wider mb-4">AI Assistant — Support Desk</div>
                        <div class="space-y-4 flex-grow">
                            <div class="bg-white/5 rounded-xl p-4 max-w-[85%]">
                                <p class="text-sm text-gray-300">"What's the process for NOC approval in our society?"</p>
                            </div>
                            <div class="bg-accent-500/10 border border-accent-500/20 rounded-xl p-4 max-w-[85%] ml-auto">
                                <p class="text-sm text-gray-300">Based on your internal policy document (Section 4.2), this request requires verification and approval. I can generate the checklist, route it to the right team, and draft the response. <span class="text-accent-400">Create workflow →</span></p>
                            </div>
                            <div class="bg-white/5 rounded-xl p-4 max-w-[85%]">
                                <p class="text-sm text-gray-300">"Show me unpaid maintenance for Block B"</p>
                            </div>
                        </div>
                        <div class="h-10 rounded-lg bg-white/5 border border-white/10 flex items-center px-4 mt-4">
                            <span class="text-xs text-gray-500">Ask anything about your society...</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="custom" class="scroll-mt-32 relative">
        <div class="absolute -top-32 -right-32 w-96 h-96 bg-red-600/10 rounded-full blur-[120px] mix-blend-screen pointer-events-none"></div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="order-2 lg:order-1" data-aos="fade-right">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-red-500/20 bg-red-500/5 text-red-400 text-xs font-bold tracking-widest uppercase mb-8">
                ...
                <div class="space-y-6 mb-10">
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                            <i class='bx bx-buildings text-xl text-red-400'></i>
                        </div>
                        <div>
                            <h4 class="text-white font-bold mb-1">Product-grade architecture</h4>
                            <p class="text-sm text-gray-500">Robust data models, modular services, clean UX patterns, and predictable delivery milestones.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                            <i class='bx bx-palette text-xl text-red-400'></i>
                        </div>
                        <div>
                            <h4 class="text-white font-bold mb-1">White-Label & Theming</h4>
                            <p class="text-sm text-gray-500">Per-tenant theme engines with preset libraries, CSS generation APIs, and admin-level customization controls.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                            <i class='bx bx-cog text-xl text-red-400'></i>
                        </div>
                        <div>
                            <h4 class="text-white font-bold mb-1">Super-Admin Consoles</h4>
                            <p class="text-sm text-gray-500">Organization onboarding, earnings dashboards, menu configuration, and platform-wide management tools.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl p-8">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            ...
                            <div class="text-xs font-bold text-white">Announcements</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-receipt text-accent mb-2'></i>
                            <div class="text-xs font-bold text-white">Maintenance</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-support text-blue-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">Helpdesk</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-group text-purple-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">Community</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-store-alt text-red-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">Vendors</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-check-shield text-green-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">SOLID Approvals</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-calendar-event text-yellow-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">Events</div>
                        </div>
                        <div class="p-3 rounded-xl bg-white/5 border border-white/10">
                            <i class='bx bx-palette text-pink-400 mb-2'></i>
                            <div class="text-xs font-bold text-white">Theme Engine</div>
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 mt-6 text-center">Every module is organization-scoped, role-protected, and API-ready.</p>
                </div>
            </div>
        </div>
    </section>
...
<section class="py-24 border-t border-white/5 bg-background">
    <div class="max-w-4xl mx-auto text-center px-6" data-aos="zoom-in">
        ...
        <p class="text-gray-400 mb-8">Tell us what you’re building — a web app, mobile product, AI feature, or a full custom platform — and we’ll propose a delivery plan.</p>
