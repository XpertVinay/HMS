...
<div class="pt-32 pb-20 relative overflow-hidden bg-background border-b border-white/5">
    ...
    <div class="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        <div data-aos="fade-up">
            ...
            <p class="text-xl text-muted font-light">Last updated: June 2026</p>
        </div>
    </div>
</div>
...
<section class="py-24 relative z-10" data-aos="fade-up" data-aos-delay="200">
    <div class="max-w-4xl mx-auto px-6 lg:px-8 prose prose-invert prose-lg">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-foreground">1. Information We Collect</h3>
        <p class="text-muted leading-relaxed mb-6">
            We may collect information about you in a variety of ways. The information we may collect includes:
        </p>
        <ul class="list-disc pl-6 text-muted mb-8 space-y-2">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-foreground">2. Use of Your Information</h3>
        <p class="text-muted leading-relaxed mb-6">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-foreground">3. Security of Your Information</h3>
        <p class="text-muted leading-relaxed mb-8">
            We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
        </p>

        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-foreground">4. Contact Us</h3>
        <p class="text-muted leading-relaxed">
            If you have questions or comments about this Privacy Policy, please contact us at:<br>
            <a href="mailto:privacy@businzo.com" class="text-primary hover:text-primary-light transition-colors">privacy@businzo.com</a>
        </p>
    </div>
</section>
@endsection
