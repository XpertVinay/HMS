...
<div class="pt-32 pb-20 relative overflow-hidden bg-background border-b border-white/5">
    ...
    <div class="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        <div data-aos="fade-up">
            ...
            <p class="text-xl text-gray-400 font-light">Effective Date: June 2026</p>
        </div>
    </div>
</div>
...
<section class="py-24 relative z-10" data-aos="fade-up" data-aos-delay="200">
    <div class="max-w-4xl mx-auto px-6 lg:px-8 prose prose-invert prose-lg">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-white">1. Agreement to Terms</h3>
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-white">2. Intellectual Property</h3>
        <p class="text-gray-400 leading-relaxed mb-6">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-white">3. Services and Estimates</h3>
        <p class="text-gray-400 leading-relaxed mb-6">
        ...
        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-white">4. Limitation of Liability</h3>
        <p class="text-gray-400 leading-relaxed mb-8">
            In no event shall Businzo Technologies, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
        </p>

        <h3 class="text-2xl font-bold font-['Outfit'] mt-12 mb-4 text-white">5. Contact Us</h3>
        <p class="text-gray-400 leading-relaxed">
            If you have any questions about these Terms, please contact us at:<br>
            <a href="mailto:legal@businzo.com" class="text-primary hover:text-blue-400 transition-colors">legal@businzo.com</a>
        </p>
    </div>
</section>
@endsection
