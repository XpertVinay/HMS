...
<div class="form-card">
    <form action="{{ route('admin.maintenance.store') }}" method="POST">
        ...
        <div class="form-group"><label>Comment/Details</label><textarea name="comment" rows="3" style="width: 100%; border: 1px solid #ddd; border-radius: 6px; padding: 10px;" required>{{ old('comment') }}</textarea></div>
