...
<div class="content-header mb-4 flex justify-between items-center">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Industry: {{ $industry->name }}</h2>
...
<div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
    <form action="{{ route('super_admin.industries.update', $industry->id) }}" method="POST">
        @csrf @method('PUT')
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" name="name" class="form-control w-full rounded-lg border-gray-300 dark:border-slate-600 dark:bg-slate-700 @error('name') border-red-500 @enderror" value="{{ old('name', $industry->name) }}" required>
        ...
        <div class="form-group mb-4">
            ...
            <input type="number" step="0.01" name="base_fee" class="form-control w-full rounded-lg border-gray-300 dark:border-slate-600 dark:bg-slate-700 @error('base_fee') border-red-500 @enderror" value="{{ old('base_fee', $industry->base_fee) }}" required>
        ...
        <div class="form-group mb-4">
            ...
            <select name="is_active" class="form-control w-full rounded-lg border-gray-300 dark:border-slate-600 dark:bg-slate-700">
        ...
        <div class="mt-6">
            <button type="submit" class="btn btn-primary px-6 py-2">
                <i class='bx bx-save mr-2'></i> Update Industry
            </button>
        </div>
    </form>
</div>
