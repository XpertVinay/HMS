    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white hover:bg-gray-50 transition-colors shadow-sm border border-gray-100 rounded-2xl p-6 flex items-center gap-5 hover:shadow-md">
            ...
            <div class="flex-grow overflow-hidden">
                <h3 class="text-lg font-bold text-gray-900 truncate">{{ $member->full_name ?: $member->username }}</h3>
                <span class="inline-block mt-1 px-2 py-1 bg-purple-100 text-purple-800 text-xs font-semibold rounded-full truncate max-w-full">
