    ...
    <div class="container mx-auto px-4 max-w-7xl py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @forelse($galleries as $photo)
                <div
                    class="relative group rounded-2xl overflow-hidden aspect-square bg-gray-100 shadow-sm border border-gray-200">
            ...
            @empty
                <div
                    class="col-span-full text-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100 border-dashed">
