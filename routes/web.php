...
$businzoRoutes = function () {
    ...
    Route::get('/portfolio', function () {
        return view('businzo.pages.portfolio');
    })->name('businzo.portfolio');
    Route::get('/portfolio/rcms', function () {
        return view('businzo.pages.portfolio-rcms');
    })->name('businzo.portfolio.rcms');
